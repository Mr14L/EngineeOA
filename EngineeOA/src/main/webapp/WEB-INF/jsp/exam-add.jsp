...
<script type="text/javascript">
	$(function(){
		$("#button1").click(function(){
			 $.post("${pageContext.request.contextPath}/exam/addExam",
      ...
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
             	<input type="number" pattern="[1-9]"  id="count" />
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <div class="am-btn-group" data-am-button>
                ...
                <label class="am-btn  am-btn-xs">
			         <input type="number" pattern="[1-9]"  id="roomNumber" placeholder="门号"/>
                </label>
              </div>
            </div>
          </div>
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <form action="" class="am-form am-form-inline">
                <div class="am-form-group am-form-icon">
                  ...
                  <input id="startTime" type="datetime-local" class="am-form-field am-input-sm" placeholder="开始时间">
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <form action="" class="am-form am-form-inline">
                <div class="am-form-group am-form-icon">
                  <i class="am-icon-calendar"></i>
                  <input id="endTime" type="datetime-local" class="am-form-field am-input-sm" placeholder="结束时间">
                </div>
              </form>
            </div>
          </div>
